        ...
        <div className="print-a4">
          ...
          <table className="print-table">
            ...
            <tbody>
              {/* 舌苔の付着程度（TCI%） */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                  ① 口腔衛生状態不良
                </td>
                <td>舌苔の付着程度</td>
                <td>50%以上</td>
                ...
                <td>{results.oralHygiene.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 口腔乾燥 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>{results.oralDryness.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 咬合力低下 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>
                  {exam.occlusion_force !== undefined &&
                  exam.occlusion_force !== null
                    ? `${exam.occlusion_force}N`
                    : "-"}
                </td>
                <td>{results.bitingForce.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 舌口唇運動機能低下 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>{results.tongueMotor.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 低舌圧 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>30kPa未満</td>
                <td>
                  {results.tonguePressureValue !== undefined &&
                  results.tonguePressureValue !== null
                    ? `${results.tonguePressureValue}kPa`
                    : "-"}
                </td>
                <td>{results.tonguePressure.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 咀嚼機能低下 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>{results.chewingFunction.score === 1 ? "☑" : ""}</td>
              </tr>
              {/* 嚥下機能低下 */}
              <tr>
                <td rowSpan={1} style={{ fontWeight: "bold" }}>
                ...
                <td>{results.swallowingFunction.score === 1 ? "☑" : ""}</td>
              </tr>
            </tbody>
          </table>
          <div
            style={{ marginTop: "8mm", fontSize: "12pt", textAlign: "right" }}
          >
            該当項目数：
            <span style={{ fontWeight: "bold", fontSize: "14pt" }}>
              {checkedCount.abnormalCount}
            </span>
          </div>
