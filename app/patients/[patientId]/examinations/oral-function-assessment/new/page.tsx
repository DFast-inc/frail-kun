...
export default function NewExaminationPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // 口腔乾燥
    oralDryness: {
      evaluationMethod: "method1", // 評価方法の選択（method1またはmethod2）
      mucusValue: "", // 評価方法1: 口腔湿潤度測定器の値
      gauzeWeight: "", // 評価方法2: ガーゼ重量増加量
      notes: "",
    },
    // 咬合力
    bitingForce: {
      evaluationMethod: "method1", // 評価方法の選択（method1またはmethod2）
      pressureScaleType: "pressScale2", // プレスケールの種類（pressScale2またはpressScale）
      useFilter: "noFilter", // フィルタの使用（withFilterまたはnoFilter）
      occlusionForce: "", // 咬合力の値
      remainingTeeth: "", // 残存歯数
      notes: "",
    },
    // 舌口唇運動機能
    ...
    chewingFunction: {
      evaluationMethod: "method1", // 評価方法の選択（method1またはmethod2）
      glucoseConcentration: "", // 評価方法1: グルコース濃度
      masticatoryScore: "", // 評価方法2: 咀嚼能率スコア
      notes: "",
    },
    // 嚥下機能
    swallowingFunction: {
      evaluationMethod: "eat10", // 評価方法の選択（eat10または聖隷式）
      eat10Score: "", // EAT-10のスコア
